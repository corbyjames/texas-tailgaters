                ...
                {games.length === 0 ? (
                  ...
                  games.map(game => (
                    <option key={game.id} value={game.id}>
                      {createLocalDate(game.date).toLocaleDateString()} - vs {game.opponent}
                    </option>
                  ))
                )}
              </select>
              ...
              <div key={category.value} className="bg-white rounded-lg shadow-sm overflow-hidden">
                <div className="px-6 py-4 flex items-center justify-between">
                  <button
                    ...
                    className="flex-1 flex items-center justify-between hover:bg-gray-50 -mx-6 px-6 py-4 transition-colors"
                  >
                  ...
                  <button
                    ...
                    className="ml-2 p-2 text-orange-500 hover:text-orange-600 hover:bg-orange-50 rounded-lg transition-colors"
                              ...
                              {item.quantityNeeded && item.quantityNeeded > 1 && (
                                <div className="mt-2">
                                  <div className="flex items-center justify-between text-xs text-gray-600 mb-1">
                                    <span>Progress</span>
                                    <span>{item.quantityBrought || 0} / {item.quantityNeeded}</span>
                                  </div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      placeholder="1"
                    />
                    <p className="text-xs text-gray-500 mt-1">How many needed?</p>
                  </div>
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-1">
                      Serving Info
                    ...
                    />
                    <p className="text-xs text-gray-500 mt-1">Optional details</p>
                  </div>
                </div>
